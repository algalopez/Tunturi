package com.algalopez.javaboilerplate.sample.api;
...
@SpringBootTest(classes = JavaBoilerplateApplication.class, webEnvironment = SpringBootTest.WebEnvironment.RANDOM_PORT)
@Transactional
public class SampleJsonAuthTest {

    private static final String PUBLIC_ENDPOINT = "/api/public/com.algalopez.javaboilerplate.sample/";
    private static final String PRIVATE_ENDPOINT = "/api/com.algalopez.javaboilerplate.sample/";
    private static final String ADMIN_ENDPOINT = "/api/admin/com.algalopez.javaboilerplate.sample/";
