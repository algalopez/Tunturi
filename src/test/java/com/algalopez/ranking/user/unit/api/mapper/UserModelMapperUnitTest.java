package com.algalopez.ranking.user.unit.api.mapper;

import com.algalopez.ranking.user.api.User;
import com.algalopez.ranking.user.api.mapper.UserModelMapper;
...
public class UserModelMapperUnitTest {
    ...
    public void testFullMapToModel() {
        ...
        com.algalopez.ranking.user.model.User modelUser = userModelMapper.mapTo(apiUser);
    ...
    public void testFullMapFromModel() {
        ...
        UserInfo modelUserInfo = UserInfo.builder()
                ...
                .level(LEVEL)
                .build();
        com.algalopez.ranking.user.model.User modelUser = com.algalopez.ranking.user.model.User.builder()
